...
class OrdersController extends AbstractController
{
    ...
    /**
     * @Route("/front/new", name="orders_front_new", methods="GET|POST")
     */
        ...
        if($this->isCsrfTokenValid('form-order', $submittedToken)) {
            if($form->isSubmitted()) {
                ...
                $query = $em->createQuery('
                    DELETE FROM App\Entity\Home\Shopcart s WHERE s.userid=:userid
                      ')
                    ->setParameter('userid', $userid);
                $query->execute();

                $this->addFlash('success', 'Siparişiniz Başarıyla Gerçekleşmiştir <b>Teşekkür Ederiz</b>');
    ...
    /**
     * @Route("/front/{id}", name="orders_show_front", methods="GET")
     */
